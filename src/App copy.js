...
function App() {
    ...
    const [largestNumber, setLargestNumber] = useState(''); // OCR로 인식된 가장 큰 숫자
        ...
        const fetchImage = async () => {
            try {
                ...
                if (response.ok) {
                    ...
                    setLargestNumber(data.largestNumber); // OCR로 인식된 가장 큰 숫자 설정
                } else {
                ...
                <div>
                    ...
                    {imageUrl && (
                        <>
                            ...
                            <p>OCR로 인식된 가장 큰 숫자: {largestNumber}</p>
                        </>
                    )}
                </div>
            )}
